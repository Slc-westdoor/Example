...
- (void)viewDidLoad
{
    ...
    if (self){
        UIView *contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height-75)];
        contentView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        contentView.backgroundColor = [UIColor whiteColor];

        CGRect view = CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height-70);
...
-(void)initNavigationItems
{
   ...
   [navigationBar pushNavigationItem:[Tool addNavigationItemsimageLeft:nil ImageRight:nil Title:@"我" color:[UIColor whiteColor] barcolor:[UIColor whiteColor] TitleLeft:@"Cancel" TitleRight:@"Done" target:self actionLeft:@selector(cancel) actionRight:@selector(done)] animated:YES];
